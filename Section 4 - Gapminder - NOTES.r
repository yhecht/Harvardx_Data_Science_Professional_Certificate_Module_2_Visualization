...
# # # SECTION 4.1: INTRO TO GAPMINDER
...
# # # SECTION 4.2: USING THE GAPMINDER DATASET
...
# HISTOGRAM OF INCOME IN WEST VS DEVELOPING WORLD, 1970 and 2010
...
# INCOME DISTRIBUTION OF WEST VS DEVELOPING WORLD, ONLY COUNTRIES WITH DATA
...
# BOXPLOTS OF INCOME IN WEST VS DEVELOPING WORLD, 1970 AND 2010
p <- gapminder %>%
